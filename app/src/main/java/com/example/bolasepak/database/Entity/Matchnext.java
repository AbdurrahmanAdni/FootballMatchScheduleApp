...
public class Matchnext {
    ...
    public Matchnext(Integer id_match, String idHomeTeam, String homeTeamName, String homeTeamScore, String homeImageURL, String homeShot,
